...
class AccountingDimensionFilter(Document):
	...
	if TYPE_CHECKING:
		...
		from nexa.accounts.doctype.allowed_dimension.allowed_dimension import AllowedDimension
		from nexa.accounts.doctype.applicable_on_account.applicable_on_account import ApplicableOnAccount
