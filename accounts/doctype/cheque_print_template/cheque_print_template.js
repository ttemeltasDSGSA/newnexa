...
frappe.provide("nexa.cheque_print");
	...
	refresh: function (frm) {
		if (!frm.doc.__islocal) {
			frm.add_custom_button(
				...
				function () {
					nexa.cheque_print.view_cheque_print(frm);
				}
...
nexa.cheque_print.view_cheque_print = function (frm) {
	frappe.call({
		method: "nexa.accounts.doctype.cheque_print_template.cheque_print_template.create_or_update_cheque_print_format",
		args: {
