...
import nexa
from nexa.accounts.doctype.journal_entry.journal_entry import get_balance_on
from nexa.accounts.utils import get_currency_precision
...
class ExchangeRateRevaluation(Document):
	...
	if TYPE_CHECKING:
		...
		from nexa.accounts.doctype.exchange_rate_revaluation_account.exchange_rate_revaluation_account import (
...
def get_account_details(
	...
	account_details = {}
	nexa.get_company_currency(company)
