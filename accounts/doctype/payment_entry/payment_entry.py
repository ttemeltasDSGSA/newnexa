...
from nexa.accounts.doctype.bank_account.bank_account import (
...
from nexa.accounts.doctype.journal_entry.journal_entry import get_default_bank_cash_account
...
from nexa.controllers.accounts_controller import (
	AccountsController,
...
class PaymentEntry(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from nexa.accounts.doctype.advance_taxes_and_charges.advance_taxes_and_charges import (
			AdvanceTaxesandCharges,
		)
		from nexa.accounts.doctype.payment_entry_deduction.payment_entry_deduction import (
			PaymentEntryDeduction,
		)
		from nexa.accounts.doctype.payment_entry_reference.payment_entry_reference import (
...
def get_reference_details(
	...
	company_currency = ref_doc.get("company_currency") or nexa.get_company_currency(ref_doc.company)
