...
from nexa.accounts.doctype.loyalty_program.loyalty_program import validate_loyalty_points
...
from nexa.controllers.queries import item_query as _item_query
from nexa.controllers.sales_and_purchase_return import get_sales_invoice_item_from_consolidated_invoice
...
class POSInvoice(SalesInvoice):
	...
	if TYPE_CHECKING:
		...
		from nexa.accounts.doctype.pos_invoice_item.pos_invoice_item import POSInvoiceItem
	...
	def validate(self):
		...
		if self.coupon_code:
			from nexa.accounts.doctype.pricing_rule.utils import validate_coupon_code
	...
	def on_submit(self):
		...
		if self.coupon_code:
			from nexa.accounts.doctype.pricing_rule.utils import update_coupon_code_count
...
def create_payments_on_invoice(doc, idx, payment_details):
	from nexa.accounts.doctype.sales_invoice.sales_invoice import get_bank_cash_account
