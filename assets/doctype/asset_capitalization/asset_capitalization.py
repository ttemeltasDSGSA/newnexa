...
import nexa
from nexa.assets.doctype.asset.asset import get_asset_value_after_depreciation
...
from nexa.stock.utils import get_incoming_rate
...
class AssetCapitalization(StockController):
	...
	if TYPE_CHECKING:
		...
		from nexa.assets.doctype.asset_capitalization_asset_item.asset_capitalization_asset_item import (
			AssetCapitalizationAssetItem,
		)
		from nexa.assets.doctype.asset_capitalization_service_item.asset_capitalization_service_item import (
			AssetCapitalizationServiceItem,
		)
		from nexa.assets.doctype.asset_capitalization_stock_item.asset_capitalization_stock_item import (
		...
		for item_row in self.stock_items:
			...
			if sle_list:
				for sle in sle_list:
					...
					if nexa.is_perpetual_inventory_enabled(self.company):
