...
from nexa.accounts.doctype.budget.budget import validate_expense_against_budget
from nexa.accounts.party import get_party_details
from nexa.buying.utils import update_last_purchase_rate, validate_for_items
...
class BuyingController(SubcontractingController):
	...
	def validate_budget(self):
		if not frappe.get_single_value("Accounts Settings", "use_legacy_budget_controller"):
			from nexa.controllers.budget_controller import BudgetValidation
