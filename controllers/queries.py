...
import nexa
from nexa.stock.get_item_details import ItemDetailsCtx, _get_item_tax_template
...
def tax_account_query(doctype, txt, searchfield, start, page_len, filters):
	doctype = "Account"
	company_currency = nexa.get_company_currency(filters.get("company"))
...
def get_income_account(doctype, txt, searchfield, start, page_len, filters):
	from nexa.controllers.queries import get_match_cond
