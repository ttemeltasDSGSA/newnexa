...
from nexa.accounts.party import render_address
from nexa.controllers.accounts_controller import get_taxes_and_charges
from nexa.controllers.sales_and_purchase_return import get_rate_for_return
from nexa.controllers.stock_controller import StockController
from nexa.stock.doctype.item.item import set_item_default
from nexa.stock.get_item_details import get_bin_details, get_conversion_factor
from nexa.stock.utils import get_combine_datetime, get_incoming_rate, get_valuation_method
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from nexa.accounts.party import _get_party_details
			...
			from nexa.crm.doctype.lead.lead import get_lead_details
	...
	def validate_items(self):
		...
		from nexa.controllers.buying_controller import validate_item_type
