...
from nexa.crm.doctype.lead.lead import make_customer
from nexa.crm.doctype.lead.test_lead import make_lead
from nexa.crm.doctype.opportunity.opportunity import make_quotation
from nexa.crm.utils import get_linked_communication_list
from nexa.tests.utils import nexaTestSuite


class TestOpportunity(nexaTestSuite):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
