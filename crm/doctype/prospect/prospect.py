...
class Prospect(CRMNote):
	...
	if TYPE_CHECKING:
		...
		from nexa.crm.doctype.prospect_lead.prospect_lead import ProspectLead
		from nexa.crm.doctype.prospect_opportunity.prospect_opportunity import ProspectOpportunity
