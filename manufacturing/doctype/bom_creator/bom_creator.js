...
frappe.ui.form.on("BOM Creator", {
	...
	make_new_entry(frm) {
		...
		dialog.fields_dict.item_code.get_query = "nexa.controllers.queries.item_query";
		dialog.show();
	},
...
nexa.bom.BomConfigurator = class BomConfigurator extends nexa.TransactionController {
	conversion_rate(doc) {
...
extend_cscript(cur_frm.cscript, new nexa.bom.BomConfigurator({ frm: cur_frm }));
