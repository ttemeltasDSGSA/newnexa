...
from nexa.manufacturing.doctype.bom.bom import add_additional_cost
from nexa.manufacturing.doctype.manufacturing_settings.manufacturing_settings import (
	get_mins_between_operations,
)
from nexa.manufacturing.doctype.workstation_type.workstation_type import get_workstations
...
class JobCard(Document):
	...
	if TYPE_CHECKING:
		...
		from nexa.manufacturing.doctype.job_card_item.job_card_item import JobCardItem
		from nexa.manufacturing.doctype.job_card_operation.job_card_operation import JobCardOperation
		from nexa.manufacturing.doctype.job_card_scheduled_time.job_card_scheduled_time import (
			JobCardScheduledTime,
		)
		from nexa.manufacturing.doctype.job_card_scrap_item.job_card_scrap_item import JobCardScrapItem
		from nexa.manufacturing.doctype.job_card_time_log.job_card_time_log import JobCardTimeLog
	...
	def make_stock_entry_for_semi_fg_item(self, auto_submit=False):
		from nexa.stock.doctype.stock_entry_type.stock_entry_type import ManufactureEntry
