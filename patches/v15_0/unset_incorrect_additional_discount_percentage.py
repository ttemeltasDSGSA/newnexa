...
from nexa.accounts.report.calculated_discount_mismatch.calculated_discount_mismatch import (
	AFFECTED_DOCTYPES,
...
def execute():
	# run this patch only if nexa version before update is v15.64.0 or higher
