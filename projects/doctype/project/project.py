...
from nexa import get_default_company
from nexa.controllers.queries import get_filters_cond
from nexa.controllers.website_list_for_contact import get_customers_suppliers
from nexa.setup.doctype.holiday_list.holiday_list import is_holiday
...
class Project(Document):
	...
	if TYPE_CHECKING:
		...
		from nexa.projects.doctype.project_user.project_user import ProjectUser
