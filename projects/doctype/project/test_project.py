...
from nexa.projects.doctype.project_template.test_project_template import make_project_template
from nexa.projects.doctype.task.test_task import create_task
from nexa.selling.doctype.sales_order.sales_order import make_project as make_project_from_so
...
class TestProject(nexaTestSuite):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
		cls.make_projects()
