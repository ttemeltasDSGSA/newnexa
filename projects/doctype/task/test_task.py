...
from nexa.projects.doctype.task.task import CircularReferenceError
from nexa.tests.utils import nexaTestSuite


class TestTask(nexaTestSuite):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
		cls.make_projects()
	...
	def test_overdue(self):
		...
		from nexa.projects.doctype.task.task import set_tasks_as_overdue
