...
nexa.accounts.bank_reconciliation.NumberCardManager = class NumberCardManager {
	constructor(opts) {
	...
	make_cards() {
		...
		chart_data.forEach((summary) => {
			let number_card = new nexa.accounts.NumberCard(summary);
...
nexa.accounts.NumberCard = class NumberCard {
	constructor(options) {
