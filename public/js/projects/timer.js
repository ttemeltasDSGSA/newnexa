frappe.provide("nexa.timesheet");

nexa.timesheet.timer = function (frm, row, timestamp = 0) {
	...
	nexa.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

nexa.timesheet.control_timer = function (frm, dialog, row, timestamp = 0) {
