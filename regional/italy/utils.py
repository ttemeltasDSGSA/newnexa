...
from nexa.controllers.taxes_and_totals import ItemWiseTaxDetail, get_itemised_tax
from nexa.regional.italy import state_codes
...
def prepare_and_attach_invoice(doc, replace=False):
	...
	invoice_xml = frappe.render_template(
		"nexa/regional/italy/e-invoice.xml",
