...
from nexa.exceptions import PartyDisabled, PartyFrozen
from nexa.selling.doctype.customer.customer import (
	get_credit_limit,
	get_customer_outstanding,
	parse_full_name,
)
from nexa.tests.utils import create_test_contact_and_address
...
class TestCustomer(IntegrationTestCase):
	...
	def test_customer_credit_limit_after_submit(self):
		from nexa.controllers.accounts_controller import update_child_qty_rate
		from nexa.selling.doctype.sales_order.test_sales_order import make_sales_order
