...
from nexa.accounts.test.accounts_mixin import AccountsTestMixin
from nexa.controllers.accounts_controller import InvalidQtyError, update_child_qty_rate
from nexa.maintenance.doctype.maintenance_schedule.test_maintenance_schedule import (
	make_maintenance_schedule,
)
from nexa.maintenance.doctype.maintenance_visit.test_maintenance_visit import (
...
from nexa.stock.get_item_details import get_bin_details
...
class TestSalesOrder(AccountsTestMixin, IntegrationTestCase):
	...
	def test_drop_shipping(self):
		from nexa.buying.doctype.purchase_order.purchase_order import update_status
		from nexa.selling.doctype.sales_order.sales_order import (
			make_purchase_order_for_default_supplier,
		)
		from nexa.selling.doctype.sales_order.sales_order import update_status as so_update_status
	...
	def test_product_bundles_in_so_are_replaced_with_bundle_items_in_po(self):
		...
		"""
		from nexa.selling.doctype.sales_order.sales_order import make_purchase_order
	...
	def test_make_work_order(self):
		from nexa.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_work_order_pop_up_from_sales_order(self):
		...
		from nexa.controllers.item_variant import create_variant
		from nexa.manufacturing.doctype.production_plan.test_production_plan import make_bom
		from nexa.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_so_cancellation_after_work_order_submission(self):
		...
		Expected result: Sales Order should not get cancelled
		"""
		from nexa.manufacturing.doctype.work_order.test_work_order import make_wo_order_test_record
	...
	def test_so_back_updated_from_wo_via_mr(self):
		...
		from nexa.manufacturing.doctype.work_order.work_order import (
			make_stock_entry as make_se_from_wo,
		)
		from nexa.stock.doctype.material_request.material_request import raise_work_orders
	...
	@patch(
		...
		"nexa.accounts.doctype.payment_request.payment_request.PaymentRequest.get_payment_url",
		return_value=None,
	)
	...
	def test_pick_list_for_batch(self):
		from nexa.stock.doctype.pick_list.pick_list import create_delivery_note
