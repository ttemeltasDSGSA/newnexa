...
def setup_demo_data():
	...
	capture("demo_data_creation_started", "nexa")
	try:
		...
		capture("demo_data_creation_failed", "nexa", properties={"exception": frappe.get_traceback()})
		raise
	capture("demo_data_creation_completed", "nexa")
...
def make_transactions(company):
	...
	from nexa.accounts.utils import FiscalYearError
