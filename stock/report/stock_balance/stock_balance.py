...
from nexa.stock.doctype.stock_closing_entry.stock_closing_entry import StockClosing
from nexa.stock.doctype.warehouse.warehouse import apply_warehouse_filter
from nexa.stock.report.stock_ageing.stock_ageing import FIFOSlots, get_average_age
from nexa.stock.utils import add_additional_uom_columns
...
class StockBalanceReport:
	...
	def set_company_currency(self) -> None:
		if self.filters.get("company"):
			self.company_currency = nexa.get_company_currency(self.filters.get("company"))
		else:
