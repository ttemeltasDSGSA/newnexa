...
def task(doc_name, from_doctype, to_doctype):
	from nexa.accounts.doctype.payment_entry import payment_entry
	from nexa.accounts.doctype.purchase_invoice import purchase_invoice
	from nexa.accounts.doctype.sales_invoice import sales_invoice
	from nexa.buying.doctype.purchase_order import purchase_order
	from nexa.buying.doctype.supplier_quotation import supplier_quotation
	from nexa.selling.doctype.quotation import quotation
	from nexa.selling.doctype.sales_order import sales_order
	from nexa.stock.doctype.delivery_note import delivery_note
	from nexa.stock.doctype.purchase_receipt import purchase_receipt
